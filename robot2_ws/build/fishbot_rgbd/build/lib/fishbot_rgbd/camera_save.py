...
class CameraSaveNode(Node):
    ...
    def process_camera(self):
        ...
        cv_depth_float = self.bridge.imgmsg_to_cv2(self.latest_depth, desired_encoding="32FC1")
        mm_depth = np.clip(cv_depth_float * 1000.0 , 0, 65535).astype(np.uint16)
        ...
        extrinsic_ok, matrix_4x4 = self.lookup_extrinsic("odom", "camera_optical_link")
        if not extrinsic_ok:
